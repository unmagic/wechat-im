...
**<font color="red">注意：SDK只测试过微信基础库1.4.0及以上版本。</font>**
...
图片文件总共大概是45kb，chat-input文件夹总共大概41kb。<font color=red>这就是SDK所有的文件，一共在90kb左右。聊天列表组件的话，文件大小在4kb左右，非常的小。需要注意的是，项目中的`.gif`文件夹包含了很多大的效果图，这个可以删除掉。</font>。
