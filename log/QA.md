...
#### 疑难问题及解答
```
1. 开发者工具提示错误`WebSocket connection to 'ws://10.4.96.52:8001/' failed: Error in connection establishment: net::ERR_CONNECTION_REFUSED`
...
3. bug: 在微信开发者工具(目前最新版是1.02.1808300)的模拟器中，调用wx.saveFile时，出现"saveFile:fail exceeded the maximum size of the file storage limit 10M"，而本地存储的文件远远没达到10M，为什么？
